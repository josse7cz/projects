<?php
// source: /data/web/virtuals/165930/virtual/www/subdom/janda/app/PublicModule/presenters/templates/Sign/uped.latte

use Latte\Runtime as LR;

class Template995b86d1aa extends Latte\Runtime\Template
{
    ...
    <body class="hold-transition register-page">
        <div class="register-box">
            ...
            <div class="register-box-body">
                ...
                <p>Na Váš email jsme poslali heslo k nově zřízenému účtu.</p>
