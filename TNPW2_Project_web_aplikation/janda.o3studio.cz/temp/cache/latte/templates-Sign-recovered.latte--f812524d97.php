<?php
// source: /data/web/virtuals/165930/virtual/www/subdom/janda/app/PublicModule/presenters/templates/Sign/recovered.latte

use Latte\Runtime as LR;

class Templatef812524d97 extends Latte\Runtime\Template
{
    ...
    <body class="hold-transition register-page">
        <div class="register-box">
            ...
            <div class="register-box-body">
                ...
                <p>Na Váš email jsme poslali odkaz k obnovení hesla.</p>
