 ...
 *
 *
 *  AvastSP.ial.productScan(json_rules, callback_function)
 *
 *
 * Test code for amazon.de product page

AvastSP.ial.productScan({
    "status":201,
...
(function(jQuery) {
  if(typeof(AvastSP) === 'undefined') AvastSP = { ial : {} };

  AvastSP.ial.productScan = function(json, callback){
